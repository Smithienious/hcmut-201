...
\begin{gather*}
  v = \exp(\int -dx/3x) = \exp((-1/3)lnx), \;x > 0
\end{gather*}
Thus
\begin{gather*}
...
\begin{align}
  \label{eq:photo_rate}
  k(T) = k(T_0)\exp(-\frac{H_a}{R}(\frac{1}{T} - \frac{1}{T_0}))
\end{align}
...
\begin{align}
  \label{eq:rubisco}
  f(T) = \frac{1 + \exp(-\frac{H_d}{R}( \frac{1}{T_0} - \frac{1}{\frac{H_d}{S}} ))}{1 + \exp(-\frac{H_d}{R}(\frac{1}{T} - \frac{1}{\frac{H_d}{S}}))}
\end{align}
...
\begin{align}
  L =L_0(1 - \frac{K \cdot \exp(-K \cdot LAI)}{1 - m})
\end{align}
...
\begin{align}
  ...
  k(T) = LAI \cdot k(T_0) \cdot \exp(-\frac{H_a}{R}(\frac{1}{T} - \frac{1}{T_0}))
\end{align}
...
\begin{align}
  J^{POT} = J^{MAX}_{25,Can} \cdot \exp(E_j\frac{T_{Can,K}-T_{25,K}}{R\cdot T_{Can,K}\cdot T_{25,K}}) \cdot \frac{1 + \exp(\frac{S\cdot T_{25,K}-H}{R\cdot T_{25,K}})}{1 + \exp(\frac{S\cdot T_{Can,K}-H}{R\cdot T_{Can,K}})}
\end{align}
...
\begin{align}
  PAR_{GhCan} = PAR_{Gh}\cdot (1-\rho_{can})\cdot(1 - \exp(-K_1\cdot LAI))
\end{align}
...
\begin{align}
  PAR_{FlrCan} = \rho_{Flr}PAR_{Gh}\cdot (1-\rho_{Can})\cdot \exp(K_1\cdot LAI) \cdot (1 - \exp(K_2\cdot LAI))
\end{align}
