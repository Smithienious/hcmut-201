...
\begin{align}
  \label{eq:photo_rate}
  k(T) = k(T_0)\exp \left(-\frac{H_a}{R}(\frac{1}{T} - \frac{1}{T_0})\right)
\end{align}
...
\begin{align}
  \label{eq:rubisco}
  f(T) = \frac{1 + \exp \left(-\frac{H_d}{R}( \frac{1}{T_0} - \frac{1}{\frac{H_d}{S}} )\right)}{1 + \exp \left(-\frac{H_d}{R}(\frac{1}{T} - \frac{1}{\frac{H_d}{S}})\right)}
\end{align}
...
\begin{align}
  L =L_0(1 - \frac{K \cdot \exp \left(-K \cdot LAI\right)}{1 - m})
\end{align}
...
\begin{align}
  ...
  k(T) = LAI \cdot k(T_0) \cdot \exp \left(-\frac{H_a}{R}(\frac{1}{T} - \frac{1}{T_0})\right)
\end{align}
