...
\begin{itemize}
  ...
  \item The function \textbf{dx} is defined as function dx\_VP() in the program, it is equivalent to equation:
        ...
        \begin{table}[H]
          ...
          \end{tabular}
        \end{table}
  \item[-] To calculate \(cap_{VP_{Air}}\), we use \(cap_{VP_{Air}} = \frac{M_{Water} h_{Air}}{R (T_{Air} + 273.15)}\) where \(h_{Air} = 4.7,\ T_{Air} = 19.8999999966472\).
  \item[-] To calculate \(cap_{VP_{Top}}\), we use \(cap_{VP_{Top}} = \frac{M_{Water} h_{Top}}{R (T_{Top} + 273.15)}\) where \(h_{Top} = 0.5999999999999996,\ T_{Top} = 21.3999999966472\).
...
\begin{versionhistory}
  \vhEntry{0.1}{21.12.2020}{NH}{Created report}
  \vhEntry{0.2}{28.12.2020}{PN}{Completed 1b}
  \vhEntry{0.3}{29.12.2020}{NH,AN}{Completed 1a, 1c}
  \vhEntry{0.4}{04.01.2021}{NH,CK,AN}{Updated 1a; Completed 2a}
  \vhEntry{0.5}{13.01.2021}{CK,PN}{Updated 2a; Completed 1d}
  \vhEntry{0.6}{14.01.2021}{HM,AN,PN}{Updated 1c, 1d; Completed 1e, 2b, 4a}
  \vhEntry{0.7}{17.01.2021}{CK,HM,PN}{Updated 1e; Completed 3}
  \vhEntry{0.8}{19.01.2021}{NH,CK,AN}{Completed 4b, 5}
\end{versionhistory}
